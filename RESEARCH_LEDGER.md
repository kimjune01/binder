...
| Who authors a contract invariant? | OpenZeppelin issues allocate assumptions among library/API/docs/application; Crucible sidecar proposes AI-authored invariants with provenance; formal-verification reports declare assumptions manually. | Medium | Inspect invariant ownership in Foundry, Echidna, Certora, Trident, and audit remediation PRs. | No |
